/**
 * The functionality for a multiple choice page type
 *
 * @author marc.newport@ninelanterns.com.au
 * @author celine.bonin@ninelanterns.com.au
 * @copyright Nine Lanterns 2013
 * @version 2.0
 * @class mp_multiple_choice
 * @extends PageType
 */
var mp_multiple_choice = PageType.extend({
  ...
  submitAnswers : function() {
    ...
    var $activity = $('#activity'),
        ...
        l_userData = [],
        l_correct = true,
        l_correctResponse = Number(this.data.responses.correct),
        l_classes = '',
