...
module.exports=function(){var o=$("#home"),t=o.height(),i=o.find(".title-big"),e=o.find(".title-small");$document.on("scroll",function(){var o=$document.scrollTop(),p=o/t*100,s=(100-p)/100;e.css({position:"relative",top:o/2+"px",opacity:s}),i.eq(0).css({position:"relative",top:o/3.5+"px",opacity:s}),i.eq(1).css({position:"relative",top:o/15+"px",opacity:s})})};
